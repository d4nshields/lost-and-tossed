...
class AppStrings {
  ...
  static const String noLocationMessage =
      'Unable to determine your location. You can still browse and contribute!';
  static const String locationPermissionDenied =
      'Location access helps you discover nearby items and share your finds with the community.';

  // Community
  static const String communityMapTitle = 'Community Discovery Map';
  static const String contributorBadge = 'Fellow Explorer';
  static const String noItemsYet =
      'No discoveries here yet. Be the first to document something interesting!';

  // Onboarding
  static const String welcomeTitle = 'Welcome to Lost & Tossed!';
  static const String welcomeSubtitle =
      'Help build a playful map of our shared spaces by documenting the objects you encounter.';
  static const String onboardingStep1 =
      'Find something interesting in public spaces';
  ...
  static const String imageUploadError =
      'Couldn\'t upload that photo. Give it another try?';
  static const String locationError =
      'Having trouble finding your location. You can still add items manually!';
  static const String genericError =
      'Something unexpected happened. Please try again.';

  // Success messages
  static const String itemSharedSuccess =
